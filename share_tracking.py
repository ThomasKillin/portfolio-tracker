...
def process_data(portfolio):
    ...
    #                                        .fillna(method='ffill')
    #                                        .fillna(0))    
    merged_portfolio = portfolio.copy()
    merged_portfolio['$'] = merged_portfolio['$'].ffill().fillna(0)
    ...
    if 'Adjustments' in merged_portfolio.columns:
        ...
        cols_with_adjustments = merged_portfolio['Adjustments'].columns
    
        merged_portfolio.loc[:, idx['Adjustments', :]] = merged_portfolio.loc[:, idx['Adjustments', :]].fillna(0)
        ...
        Div = (merged_portfolio['Div'][cols_with_adjustments] +
               merged_portfolio['Adjustments'][cols_with_adjustments] * 
               merged_portfolio['Div'][cols_with_adjustments].cumsum())
    ...
    Div_tot = (merged_portfolio['Div'] * Accum).round(2)
    # Reset column names
    ...
    merged_portfolio = pd.concat([merged_portfolio, Buy_amt, Accum, Val, Div_tot], axis=1)
